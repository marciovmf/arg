...
{
  ARGExpectedOption optionA = { L"-a", L"param", L"Specify zero or one integer value", INTEGER, 1, 1, false, LAYER_0 };
  ...
  ARGExpectedOption optionHelp = { L"-h", L"param", L"Displays this help.", STRING, 0, 0, false, LAYER_1 };
  ARGExpectedOption optionReminder0 = { L"Input files", L"param", L"A list of files to process", REMINDER, 0, 0, true, LAYER_0};
